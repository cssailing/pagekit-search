...
use Pagekit\Search\Helpers\EXTransliterate;
use Pagekit\Search\Helpers\EXDefaultLocalise;
...
class EXSearchHelper
{
    ...
    */
	...
	public function __construct()
    {
		...
		date_default_timezone_set('Asia/Shanghai');// set date timezone
	...
	*/
	...
	public static function logSearch($search_term = null)
	{
		...
		if (!is_null($search_term)){
			...
			//ipv6 error
			$SearchKeywords->ip = ip2long(App::request()->getClientIp()?'0.0.0.0': App::request()->getClientIp());
