...
class SearchNewsPlugin implements EventSubscriberInterface
{
	...
	{
		if (!$newslist = App::module('news')) {return;}
		static $areas = array();
		$areas = ['news' => __('News')];
	...
	{
		if (!$news = App::module('news')) {return;}
		static $areas = array();
		$areas = ['news' => __('News')]; 
		return $areas;
	}
